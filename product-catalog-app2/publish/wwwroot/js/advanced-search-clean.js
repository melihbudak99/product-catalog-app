/**
 * ADVANCED SEARCH MODULE - Clean Version
...
class AdvancedSearchManager {
    ...
    restoreState() {
        // Sayfa yüklendiğinde önceki durumu geri yükle
        const isOpen = localStorage.getItem('advancedSearchOpen') === 'true';
    ...
    isOpen() {
        const advancedFilters = document.getElementById('advancedFilters');
        return advancedFilters && !advancedFilters.classList.contains('hidden');
    }
    ...
    reset() {
        ...
        // Gelişmiş aramayı kapat
        const advancedFilters = document.getElementById('advancedFilters');
        const toggleBtn = document.querySelector('.btn-toggle-advanced');
        
        if (advancedFilters && toggleBtn && this.isOpen()) {
            this.hide(advancedFilters, toggleBtn);
        }
